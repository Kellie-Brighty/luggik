...
export default function RunnerLogin() {
  ...
  const { user, role, kycStatus, refreshKycStatus } = useAuth();
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#F7F4EC] font-[Inter,sans-serif]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-20">
        <div className="w-full max-w-[420px]">
          <h2 className="text-[32px] tracking-[-0.02em] font-bold text-black font-['Space_Grotesk',sans-serif] mb-2">Welcome back</h2>
          <p className="text-[14.5px] text-[#6E6B5E] leading-[22.48px] mb-10">
            Log in to your Logistics Partner account to view and accept errands.
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-[13.5px] font-semibold text-[#0B0F0E]">Password</label>
                <Link to="#" className="text-[12.5px] font-medium text-[#6E6B5E] hover:text-[#0B0F0E] transition-colors">
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-8 text-center text-[14px] text-[#6E6B5E]">
            Don't have an account? <Link to="/runner/signup" className="font-semibold text-[#0B0F0E] hover:underline">Sign up</Link>
          </div>
        </div>
      </div>
    </div>
